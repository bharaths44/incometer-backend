...
public class CategoryServiceTest {
    ...
    void testAddCategory() {
        ...
        when(categoryRepository.existsByUserUserIdAndNameAndType(1L, "Food", TransactionType.EXPENSE)).thenReturn(false);
        when(categoryRepository.save(any(Category.class))).thenReturn(category);

        System.out.println("Input: " + request);
        CategoryResponseDTO expected = new CategoryResponseDTO(1L, 1L, "Food", "utensils", TransactionType.EXPENSE, category.getCreatedAt());
    ...
    void testGetCategoriesByUserId() {
        ...
        List<CategoryResponseDTO> expected = List.of(new CategoryResponseDTO(1L, 1L, "Food", "utensils", TransactionType.EXPENSE, category.getCreatedAt()));
        System.out.println("Expected: " + expected);
