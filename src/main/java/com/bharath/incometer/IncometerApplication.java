            ...
            try (var executor = Executors.newSingleThreadExecutor()) {
                executor.submit(() -> {
                    try {
                        ...
                        ProcessBuilder pb = os.contains("win") ? new ProcessBuilder("cmd.exe", "/c", command) : new ProcessBuilder("sh", "-c", command);
                        ...
                        if (exitCode != 0) {
                            ...
                            System.out.println("💡 Ensure Node.js and LocalTunnel are installed. Alternatively, expose port 8080 manually.");
                        } else {
